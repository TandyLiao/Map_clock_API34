...
public class BookFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        confirmButton.setOnClickListener(v -> {
            Intent intentCreateBookmark = new Intent(getActivity(), CreateBookmark.class);
            startActivityForResult(intentCreateBookmark, CREATE_BOOKMARK_REQUEST);
        });
    ...
    private final BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        if (menuItem.getItemId() == R.id.action_create_bookmark) {
            Intent intent = new Intent(getActivity(), CreateBookmark.class);
